let ImageFlex = {
    template: `<div>
              ...
              v-if="item.category == NavName"> 
               ...
               noresize="noresize"
               style="position: absolute; background: transparent; width:1080px; height:790px;
               transform: scale(0.5); top:-198px; left:-270px;"
               v-bind:src="item.htmlurl"
               frameborder="0">
               </iframe>
               <iframe frameborder="0"
               noresize="noresize"
               style="position: absolute; background: transparent; width:480px; height:820px;
               transform: scale(0.47); top:-218px; left:414px;"
               v-bind:src="item.htmlurl"
               frameborder="0">
               </iframe>
               </div>
    ...
    computed:{
      contents() {
      return this.$store.state.contents.basic;
    },
    messages() {

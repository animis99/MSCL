let Card = {
    template: `<div>
              ...
              v-if="item.category == NavName"> 
               ...
               noresize="noresize"
               style="position: absolute; background: transparent; width:1080px; height:778px;
               ...
               <iframe frameborder="0"
               noresize="noresize"
               style="position: absolute; background: transparent; width:480px; height:818px;
               transform: scale(0.47); top:-216px; left:414px;"
               v-bind:src="item.htmlurl"
               frameborder="0">
               </iframe>
               </div>

let bootstap = {
  ...
  data: function() {
    return {
      informs:[{method:"createHandler",category:"navbar", title: "" , html:"", css:"", javascript:""},
      {method:"createHandler",category:"圖片輪播", title: "" , html:"", css:"", javascript:""},
      {method:"createHandler",category:"圖文佈局", title: "" , html:"", css:"", javascript:""},
      {method:"createHandler",category:"卡片", title: "" , html:"", css:"", javascript:""}],  
  ...
  computed: {
    contents() {
      return this.$store.state.contents2;
    }
  },
  methods: {
    ...
    createHandler(method, category, title, htmlurl, html, css, javascript){
      ...
      axios
        .post("http://localhost:3000/Bootstrap", {
          category:category,
          title:title,
          htmlurl:htmlurl,
          html:html,
        ...
        .then(res => {
          ...
          this.$store.commit("addContent2", res.data);
        });
    },
    deleteHandler(index) {
      ...
      // })
      this.$store.dispatch("CONTENT_DELETE2", { target });
    },
    updateHandler(index) {
      console.log('路徑2');
      let target = this.contents[index];
      ...
      this.$router.push({ name: "update2", params: { id: target.id } });
